            ...
            <div className="relative flex justify-center items-center">
              <div className={`flex flex-wrap justify-center items-center ${isTeamVsTeam && teamsToDisplay.length > 2 ? 'gap-6' : 'gap-12'}`}>
                {teamsToDisplay.map((currentTeam, teamIndex) => (
                  <React.Fragment key={`team-section-${currentTeam.id}`}>
                    <motion.div
                      key={currentTeam.id}
                    ...
                    {/* Insert VS badge between teams (except after the last team) */}
                    {showVsText && isTeamVsTeam && teamIndex < teamsToDisplay.length - 1 && (
                      <motion.div
                        key={`vs-${teamIndex}`}
                        className="z-10 mx-2"
                      ...
                      >
                        ...
                        >
                          <span className="text-md font-black text-white">VS</span>
                        </motion.div>
                      </motion.div>
                    )}
                  </React.Fragment>
